...
library(sf); library(ggmap); library(mapview)
...
#   theme_void()
mapview(sf_park, layer.name = "Sheffield Park Academy", zoom = 14)
```

*TODO: Check school projection is correct*
